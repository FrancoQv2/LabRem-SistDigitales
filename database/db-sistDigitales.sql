-- -----------------------------------------------------
-- Schema LabRem_SistemasDigitales
-- -----------------------------------------------------
...
DROP DATABASE IF EXISTS LabRem_SistemasDigitales;
CREATE DATABASE IF NOT EXISTS LabRem_SistemasDigitales DEFAULT CHARACTER SET utf8mb4;
