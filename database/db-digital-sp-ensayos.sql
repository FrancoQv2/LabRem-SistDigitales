...
DROP PROCEDURE IF EXISTS sp_dameEnsayosUART;

DELIMITER //
CREATE PROCEDURE sp_dameEnsayosUART()
SALIR: BEGIN
	SELECT 
		idEnsayo, 
        idUsuario,
...
DROP PROCEDURE IF EXISTS sp_dameEnsayosI2C;

DELIMITER //
CREATE PROCEDURE sp_dameEnsayosI2C()
SALIR: BEGIN
	SELECT 
		idEnsayo, 
        idUsuario,
